...
const Header: FunctionComponent = (): JSX.Element => {
  ...
  return (
    <div className="relative w-full h-fit flex flex-col gap-3 bg-white">
      <div className="relative px-2 w-full h-fit sm:h-16 flex flex-col gap-4 sm:flex-row justify-between items-center z-200">
        ...
        <div className="relative flex flex-row gap-2 items-center justify-center w-full sm:w-fit h-fit">
                      ...
                      return (
                        <>
                          {(item as NFTData)?.prices?.length > 0 ? (
                            <div
                              key={key}
                              className="cursor-canP relative w-full h-fit flex flex-row gap-2 items-center justify-between hover:opacity-70 cursor-canP"
                              onClick={() => {
          ...
          <div className="relative flex items-center justify-center w-fit h-fit">
            <div
              className="relative w-10 h-10 flex items-center justify-center cursor-canP active:scale-95 cursor-canP"
              ...
              <div className="absolute w-40 h-fit rounded-md flex right-0 top-12 flex-col gap-5 shadow-lg p-2 text-xxs font-jackey pixel-border-3 z-250">
                ...
                <div className="relative w-full h-fit flex flex-col gap-2 font-jack">
                  {context?.lensConnected?.profile && address && (
                    <div
                      className="relative flex w-full h-10 rounded-xl bg-[#FD91C6] active:scale-95 items-center justify-center text-center text-sm text-black hover:opacity-80 cursor-canP pixel-border-4"
                      onClick={() => {
                        animationContext?.setPageChange?.(true);
                  ...
                  <div
                    className="relative flex w-full h-10 rounded-xl bg-black active:scale-95 items-center justify-center text-center text-sm text-white hover:opacity-80 cursor-canP pixel-border-4"
                    onClick={() =>
                      isConnected
                        ? openProfile?.()
      ...
      <div className="relative w-full h-fit flex px-2">
        <Slider />
      </div>
      <div className="relative w-full h-4 bg-gradient-to-r from-[#EA5EFF] to-[#9568F6] flex"></div>
    </div>
  );
};
