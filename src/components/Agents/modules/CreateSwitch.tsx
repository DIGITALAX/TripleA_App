...
const CreateSwitch: FunctionComponent<CreateSwitchProps> = ({
  ...
  switch (createSwitcher) {
    case CreateSwitcher.Success:
      return (
        <div className="relative w-full h-full flex flex-col gap-6 text-windows items-center justify-center">
    ...
    case CreateSwitcher.Create:
      return (
        <div className="relative w-full h-full flex flex-col gap-6 items-center justify-between p-4 font-nerd text-windows">
          ...
          <div className="relative w-full h-fit flex items-center justify-center">
            <div
              className={`relative w-full sm:w-1/2 h-14 font-nerd bg-viol text-windows pixel-border-7 flex items-center justify-center text-lg text-center hover:opacity-80 ${
        ...
        <div className="relative font-nerd w-full h-full flex flex-col gap-6 items-center justify-center text-windows p-4">
          ...
          <div className="relative w-full h-fit flex flex-col gap-3 items-center justify-center">
            <div className="relative items-center justify-center flex w-fit h-fit">
              <label
                className="relative w-20 rounded-full h-20 flex items-center justify-center border border-windows cursor-canP bg-viol"
                onClick={(e) => {
                  e.stopPropagation();
                }}
              >
    ...
    default:
      return (
        <div className="relative w-full h-full flex flex-col sm:flex-row gap-6 items-center justify-center font-nerd p-4">
          ...
          <div className="relative w-full h-full flex flex-col gap-5 items-start justify-start">
            <div className="relative w-full h-full flex flex-col justify-start items-start gap-5">
              ...
              />
              <textarea
                className="relative flex w-full h-1/2 overflow-y-scroll text-left text-viol bg-windows rounded-md p-1.5 focus:outline-none text-lg"
            ...
            <div className="relative w-full h-full flex items-start justify-start flex-col gap-2">
              ...
              <textarea
                className="relative flex w-full h-full overflow-y-scroll text-left text-viol bg-windows rounded-md p-1.5 focus:outline-none text-lg"
